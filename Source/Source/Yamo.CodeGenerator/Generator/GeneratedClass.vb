Namespace Generator
  ...
  Public Enum GeneratedClass
    ...
    FilteredSelectSqlExpression
    GroupedSelectSqlExpression
    HavingSelectSqlExpression
    OrderedSelectSqlExpression
    LimitedSelectSqlExpression
    SelectedSelectSqlExpression
