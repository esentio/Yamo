...
Namespace Expressions
  ...
  Public Class SelectSqlExpression(Of T1, T2, T3)
    ...
    ''' <returns></returns>
    Public Function Join(Of TJoined)(<DisallowNull> tableSourceFactory As Func(Of SubqueryContext, Subquery(Of TJoined))) As JoinSelectSqlExpression(Of T1, T2, T3, TJoined)
    ...
    ''' <param name="tableSourceFactory"></param>
    ''' <returns></returns>
    Public Function LeftJoin(Of TJoined)(<DisallowNull> tableSourceFactory As Func(Of SubqueryContext, Subquery(Of TJoined))) As JoinSelectSqlExpression(Of T1, T2, T3, TJoined)
    ...
    ''' <param name="tableSourceFactory"></param>
    ''' <returns></returns>
    Public Function RightJoin(Of TJoined)(<DisallowNull> tableSourceFactory As Func(Of SubqueryContext, Subquery(Of TJoined))) As JoinSelectSqlExpression(Of T1, T2, T3, TJoined)
    ...
    ''' <param name="tableSourceFactory"></param>
    ''' <returns></returns>
    Public Function FullJoin(Of TJoined)(<DisallowNull> tableSourceFactory As Func(Of SubqueryContext, Subquery(Of TJoined))) As JoinSelectSqlExpression(Of T1, T2, T3, TJoined)
    ...
    ''' <param name="tableSourceFactory"></param>
    ''' <returns></returns>
    Public Function CrossJoin(Of TJoined)(<DisallowNull> tableSourceFactory As Func(Of SubqueryContext, Subquery(Of TJoined))) As JoinedSelectSqlExpression(Of T1, T2, T3, TJoined)
    ...
    ''' <param name="tableSourceFactory"></param>
    ''' <returns></returns>
    Private Function InternalJoin(Of TJoined)(joinType As JoinType, tableSourceFactory As Func(Of SubqueryContext, Subquery(Of TJoined))) As JoinSelectSqlExpression(Of T1, T2, T3, TJoined)
