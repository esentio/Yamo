...
Namespace Expressions
  ...
  ''' <summary>
  ''' Represents SQL SELECT statement from 3 tables (entities) and (at least) last one has defined table hints.
  ''' </summary>
  ''' <typeparam name="T1"></typeparam>
  ''' <typeparam name="T2"></typeparam>
  ''' <typeparam name="T3"></typeparam>
  Public Class JoinWithHintsSelectSqlExpression(Of T1, T2, T3)
    Inherits SelectSqlExpressionBase

    ''' <summary>
    ''' Creates new instance of <see cref="JoinWithHintsSelectSqlExpression(Of T1, T2, T3)"/>.
    ''' </summary>
