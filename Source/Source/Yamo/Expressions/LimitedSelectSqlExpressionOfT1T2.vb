...
Namespace Expressions
  ...
  Public Class LimitedSelectSqlExpression(Of T1, T2)
    ...
    ''' <returns></returns>
    Public Function [If](Of TResult)(condition As Boolean, [then] As Func(Of LimitedSelectSqlExpression(Of T1, T2), TResult), Optional otherwise As Func(Of LimitedSelectSqlExpression(Of T1, T2), TResult) = Nothing) As TResult
