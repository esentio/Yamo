...
Namespace Expressions
  ...
  Public Class JoinSelectSqlExpression(Of T1, T2)
    ...
    ''' <returns></returns>
    Public Function [If](Of TResult)(condition As Boolean, [then] As Func(Of JoinSelectSqlExpression(Of T1, T2), TResult), otherwise As Func(Of JoinSelectSqlExpression(Of T1, T2), TResult)) As TResult
      If condition Then
