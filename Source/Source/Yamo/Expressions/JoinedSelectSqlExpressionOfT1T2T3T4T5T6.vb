...
Namespace Expressions
  ...
  Public Class JoinedSelectSqlExpression(Of T1, T2, T3, T4, T5, T6)
    ...
    ''' <returns></returns>
    Public Function [If](Of TResult)(condition As Boolean, [then] As Func(Of JoinedSelectSqlExpression(Of T1, T2, T3, T4, T5, T6), TResult), Optional otherwise As Func(Of JoinedSelectSqlExpression(Of T1, T2, T3, T4, T5, T6), TResult) = Nothing) As TResult
