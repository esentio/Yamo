...
Namespace Expressions
  ...
  Public Class JoinSelectSqlExpression(Of T1, T2, T3, T4, T5, T6, T7)
    ...
    ''' <returns></returns>
    Public Function [If](Of TResult)(condition As Boolean, [then] As Func(Of JoinSelectSqlExpression(Of T1, T2, T3, T4, T5, T6, T7), TResult), otherwise As Func(Of JoinSelectSqlExpression(Of T1, T2, T3, T4, T5, T6, T7), TResult)) As TResult
      If condition Then
