...
Namespace Expressions
  ...
  Public Class OrderedSelectSqlExpression(Of T1, T2, T3)
    ...
    Public Function ThenBy(Of TKey)(keySelector As Expression(Of Func(Of T1, T2, T3, TKey))) As OrderedSelectSqlExpression(Of T1, T2, T3)
    ...
    Public Function ThenByDescending(Of TKey)(keySelector As Expression(Of Func(Of T1, T2, T3, TKey))) As OrderedSelectSqlExpression(Of T1, T2, T3)
