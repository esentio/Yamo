  ...
  Public Class ModelFactory
    ...
    Public Overridable Function CreateItemWithAllSupportedValuesWithEmptyValues() As ItemWithAllSupportedValues
      Return New ItemWithAllSupportedValues With {
        ...
        .TimeColumn = Helpers.Calendar.Now().TimeOfDay,
        .TimeColumnNull = Nothing,
        .DatetimeColumn = Helpers.Calendar.Now(),
        .DatetimeColumnNull = Nothing,
        .Datetime2Column = Helpers.Calendar.Now(),
        .Datetime2ColumnNull = Nothing,
        .DatetimeoffsetColumn = Helpers.Calendar.OffsetNow(),
        .DatetimeoffsetColumnNull = Nothing,
    ...
    Public Overridable Function CreateItemWithAllSupportedValuesWithMinValues() As ItemWithAllSupportedValues
      Return New ItemWithAllSupportedValues With {
        ...
        .DateColumn = Helpers.Calendar.GetSqlServerMinDate(),
        .DateColumnNull = Helpers.Calendar.GetSqlServerMinDate(),
        .TimeColumn = Helpers.Calendar.GetSqlServerMinTime(),
        .TimeColumnNull = Helpers.Calendar.GetSqlServerMinTime(),
        .DatetimeColumn = Helpers.Calendar.GetSqlServerMinDateTime(),
        .DatetimeColumnNull = Helpers.Calendar.GetSqlServerMinDateTime(),
        .Datetime2Column = Helpers.Calendar.GetSqlServerMinDateTime2(),
        .Datetime2ColumnNull = Helpers.Calendar.GetSqlServerMinDateTime2(),
        .DatetimeoffsetColumn = Helpers.Calendar.GetSqlServerMinDateTimeOffset(),
        .DatetimeoffsetColumnNull = Helpers.Calendar.GetSqlServerMinDateTimeOffset(),
        .Varbinary50Column = New Byte() {},
    ...
    Public Overridable Function CreateItemWithAllSupportedValuesWithMaxValues() As ItemWithAllSupportedValues
      Return New ItemWithAllSupportedValues With {
        ...
        .Numeric15and0Column = 999999999999999D,
        .Numeric15and0ColumnNull = 999999999999999D,
        .DateColumn = Helpers.Calendar.GetSqlServerMaxDate(),
        .DateColumnNull = Helpers.Calendar.GetSqlServerMaxDate(),
        .TimeColumn = Helpers.Calendar.GetSqlServerMaxTime(),
        .TimeColumnNull = Helpers.Calendar.GetSqlServerMaxTime(),
        .DatetimeColumn = Helpers.Calendar.GetSqlServerMaxDateTime(),
        .DatetimeColumnNull = Helpers.Calendar.GetSqlServerMaxDateTime(),
        .Datetime2Column = Helpers.Calendar.GetSqlServerMaxDateTime2(),
        .Datetime2ColumnNull = Helpers.Calendar.GetSqlServerMaxDateTime2(),
        .DatetimeoffsetColumn = Helpers.Calendar.GetSqlServerMaxDateTimeOffset(),
        .DatetimeoffsetColumnNull = Helpers.Calendar.GetSqlServerMaxDateTimeOffset(),
